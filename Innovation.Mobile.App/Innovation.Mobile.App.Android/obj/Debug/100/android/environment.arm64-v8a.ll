...
@__app_environment_variables_v_2.5 = internal constant [37 x i8] c"74b6e58a-3d86-45cd-ad95-76f7ec0686d9\00", align 1
...
@__ApplicationConfig_android_package_name.0 = internal constant [38 x i8] c"com.innovation.mobile.app.erp.android\00", align 1
...
@application_config = local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 167, ; number_of_assemblies_in_apk
...
@__DSOCacheEntry_name.1 = internal constant [23 x i8] c"libDXListViewNative.so\00", align 1
@__DSOCacheEntry_name.2 = internal constant [22 x i8] c"libDXEditorsNative.so\00", align 1
...
@__DSOCacheEntry_name.8 = internal constant [19 x i8] c"libDXGridNative.so\00", align 1
...
@dso_cache = local_unnamed_addr global [44 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 849092074262241825, ; hash 0xbc894be2c002221, from name: DXListViewNative.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__DSOCacheEntry_name.1, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 1
	%struct.DSOCacheEntry {
		i64 1268605975802832462, ; hash 0x119afe69e3aa664e, from name: libDXEditorsNative.so
		i8 0, ; ignore
	...
	; 4
	%struct.DSOCacheEntry {
		i64 1896939921227027235, ; hash 0x1a5348ced4fe9323, from name: DXEditorsNative.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([22 x i8], [22 x i8]* @__DSOCacheEntry_name.2, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 10
	%struct.DSOCacheEntry {
		i64 3919070131155356201, ; hash 0x36635585295bca29, from name: DXGridNative
		i8 0, ; ignore
	...
	; 11
	%struct.DSOCacheEntry {
		i64 4065284226194587797, ; hash 0x386aca770553c095, from name: libDXListViewNative
		i8 0, ; ignore
		i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__DSOCacheEntry_name.1, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 27
	%struct.DSOCacheEntry {
		i64 10897721102435561453, ; hash 0x973c7b9aa3f32fed, from name: DXEditorsNative
		i8 0, ; ignore
		i8* getelementptr inbounds ([22 x i8], [22 x i8]* @__DSOCacheEntry_name.2, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 29
	%struct.DSOCacheEntry {
		i64 12086379666364500716, ; hash 0xa7bb72452a290aec, from name: DXListViewNative
		i8 0, ; ignore
		i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__DSOCacheEntry_name.1, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 30
	%struct.DSOCacheEntry {
		i64 12310907846995770012, ; hash 0xaad92175fac07a9c, from name: libDXGridNative.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([19 x i8], [19 x i8]* @__DSOCacheEntry_name.8, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 31
	%struct.DSOCacheEntry {
		i64 12851305792227007547, ; hash 0xb2590287659c5c3b, from name: libDXGridNative
		i8 0, ; ignore
		i8* getelementptr inbounds ([19 x i8], [19 x i8]* @__DSOCacheEntry_name.8, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 34
	%struct.DSOCacheEntry {
		i64 14135610387345056506, ; hash 0xc42bc6c0ed0622fa, from name: libDXEditorsNative
		i8 0, ; ignore
		i8* getelementptr inbounds ([22 x i8], [22 x i8]* @__DSOCacheEntry_name.2, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 40
	%struct.DSOCacheEntry {
		i64 16862096864367537580, ; hash 0xea0233c248daedac, from name: DXGridNative.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([19 x i8], [19 x i8]* @__DSOCacheEntry_name.8, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 41
	%struct.DSOCacheEntry {
		i64 16962607451521703410, ; hash 0xeb67499afc585df2, from name: libDXListViewNative.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__DSOCacheEntry_name.1, i32 0, i32 0), ; name
		i8* null; handle
	}, 
...
@__XamarinAndroidBundledAssembly_name_137 = internal global [65 x i8] zeroinitializer, align 1
@__XamarinAndroidBundledAssembly_name_138 = internal global [65 x i8] zeroinitializer, align 1
@__XamarinAndroidBundledAssembly_name_139 = internal global [65 x i8] zeroinitializer, align 1
@__XamarinAndroidBundledAssembly_name_140 = internal global [65 x i8] zeroinitializer, align 1
@__XamarinAndroidBundledAssembly_name_141 = internal global [65 x i8] zeroinitializer, align 1
@__XamarinAndroidBundledAssembly_name_142 = internal global [65 x i8] zeroinitializer, align 1
@__XamarinAndroidBundledAssembly_name_143 = internal global [65 x i8] zeroinitializer, align 1
@__XamarinAndroidBundledAssembly_name_144 = internal global [65 x i8] zeroinitializer, align 1
@__XamarinAndroidBundledAssembly_name_145 = internal global [65 x i8] zeroinitializer, align 1
@__XamarinAndroidBundledAssembly_name_146 = internal global [65 x i8] zeroinitializer, align 1
@__XamarinAndroidBundledAssembly_name_147 = internal global [65 x i8] zeroinitializer, align 1
@__XamarinAndroidBundledAssembly_name_148 = internal global [65 x i8] zeroinitializer, align 1
@__XamarinAndroidBundledAssembly_name_149 = internal global [65 x i8] zeroinitializer, align 1
@__XamarinAndroidBundledAssembly_name_150 = internal global [65 x i8] zeroinitializer, align 1
@__XamarinAndroidBundledAssembly_name_151 = internal global [65 x i8] zeroinitializer, align 1
@__XamarinAndroidBundledAssembly_name_152 = internal global [65 x i8] zeroinitializer, align 1
@__XamarinAndroidBundledAssembly_name_153 = internal global [65 x i8] zeroinitializer, align 1
@__XamarinAndroidBundledAssembly_name_154 = internal global [65 x i8] zeroinitializer, align 1
@__XamarinAndroidBundledAssembly_name_155 = internal global [65 x i8] zeroinitializer, align 1
@__XamarinAndroidBundledAssembly_name_156 = internal global [65 x i8] zeroinitializer, align 1
@__XamarinAndroidBundledAssembly_name_157 = internal global [65 x i8] zeroinitializer, align 1
@__XamarinAndroidBundledAssembly_name_158 = internal global [65 x i8] zeroinitializer, align 1
@__XamarinAndroidBundledAssembly_name_159 = internal global [65 x i8] zeroinitializer, align 1
@__XamarinAndroidBundledAssembly_name_160 = internal global [65 x i8] zeroinitializer, align 1
@__XamarinAndroidBundledAssembly_name_161 = internal global [65 x i8] zeroinitializer, align 1
@__XamarinAndroidBundledAssembly_name_162 = internal global [65 x i8] zeroinitializer, align 1
@__XamarinAndroidBundledAssembly_name_163 = internal global [65 x i8] zeroinitializer, align 1
@__XamarinAndroidBundledAssembly_name_164 = internal global [65 x i8] zeroinitializer, align 1
@__XamarinAndroidBundledAssembly_name_165 = internal global [65 x i8] zeroinitializer, align 1
@__XamarinAndroidBundledAssembly_name_166 = internal global [65 x i8] zeroinitializer, align 1


; Bundled assembly name buffers, all 65 bytes long
@bundled_assemblies = local_unnamed_addr global [167 x %struct.XamarinAndroidBundledAssembly] [
	; 0
