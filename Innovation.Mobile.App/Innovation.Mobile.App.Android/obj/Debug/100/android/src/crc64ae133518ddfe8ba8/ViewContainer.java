...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DevExpress.XamarinForms.DataGrid.Android.ViewContainer, DevExpress.XamarinForms.Grid.Android", ViewContainer.class, __md_methods);
	}
	...
	public ViewContainer (android.content.Context p0, android.util.AttributeSet p1, int p2, int p3)
	{
		super (p0, p1, p2, p3);
		if (getClass () == ViewContainer.class) {
			mono.android.TypeManager.Activate ("DevExpress.XamarinForms.DataGrid.Android.ViewContainer, DevExpress.XamarinForms.Grid.Android", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android:System.Int32, mscorlib:System.Int32, mscorlib", this, new java.lang.Object[] { p0, p1, p2, p3 });
		}
	}
