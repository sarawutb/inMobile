...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"n_getAllowFullSwipe:(ILcom/devexpress/dxlistview/swipes/DXSwipeGroup;)Ljava/lang/Boolean;:GetGetAllowFullSwipe_ILcom_devexpress_dxlistview_swipes_DXSwipeGroup_Handler:Com.Devexpress.Dxlistview.Swipes.IDXSwipeItemsViewProviderInvoker, DevExpress.Xamarin.Android.CollectionView\n" +
			"n_getSwipeViewColors:(ILcom/devexpress/dxlistview/swipes/DXSwipeGroup;)Ljava/util/List;:GetGetSwipeViewColors_ILcom_devexpress_dxlistview_swipes_DXSwipeGroup_Handler:Com.Devexpress.Dxlistview.Swipes.IDXSwipeItemsViewProviderInvoker, DevExpress.Xamarin.Android.CollectionView\n" +
			"n_getSwipeViewSizes:(ILcom/devexpress/dxlistview/swipes/DXSwipeGroup;)Ljava/util/List;:GetGetSwipeViewSizes_ILcom_devexpress_dxlistview_swipes_DXSwipeGroup_Handler:Com.Devexpress.Dxlistview.Swipes.IDXSwipeItemsViewProviderInvoker, DevExpress.Xamarin.Android.CollectionView\n" +
			"n_getSwipeViews:(ILcom/devexpress/dxlistview/swipes/DXSwipeGroup;)Ljava/util/List;:GetGetSwipeViews_ILcom_devexpress_dxlistview_swipes_DXSwipeGroup_Handler:Com.Devexpress.Dxlistview.Swipes.IDXSwipeItemsViewProviderInvoker, DevExpress.Xamarin.Android.CollectionView\n" +
			"n_isSwipeAllowed:(ILcom/devexpress/dxlistview/swipes/DXSwipeGroup;)Ljava/lang/Boolean;:GetIsSwipeAllowed_ILcom_devexpress_dxlistview_swipes_DXSwipeGroup_Handler:Com.Devexpress.Dxlistview.Swipes.IDXSwipeItemsViewProviderInvoker, DevExpress.Xamarin.Android.CollectionView\n" +
			"n_recycleViews:(ILcom/devexpress/dxlistview/swipes/DXSwipeGroup;Ljava/util/List;)V:GetRecycleViews_ILcom_devexpress_dxlistview_swipes_DXSwipeGroup_Ljava_util_List_Handler:Com.Devexpress.Dxlistview.Swipes.IDXSwipeItemsViewProviderInvoker, DevExpress.Xamarin.Android.CollectionView\n" +
			"";
