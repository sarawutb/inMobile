...
public class ItemSourceAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DevExpress.XamarinForms.Editors.Android.TextEdit.ItemSourceAdapter, DevExpress.XamarinForms.Editors.Android", ItemSourceAdapter.class, __md_methods);
	}
	...
	public ItemSourceAdapter (android.content.Context p0)
	{
		...
		if (getClass () == ItemSourceAdapter.class) {
			mono.android.TypeManager.Activate ("DevExpress.XamarinForms.Editors.Android.TextEdit.ItemSourceAdapter, DevExpress.XamarinForms.Editors.Android", "Android.Content.Context, Mono.Android", this, new java.lang.Object[] { p0 });
		}
	}
