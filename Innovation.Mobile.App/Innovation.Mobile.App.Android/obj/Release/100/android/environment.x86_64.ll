...
@__app_environment_variables_v_2.5 = internal constant [37 x i8] c"06e9b5bc-50d8-47d5-b54b-b0754fcaf29a\00", align 16
...
@application_config = local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 33555459, ; android_runtime_jnienv_class_token
	i32 100674902, ; jnienv_initialize_method_token
	i32 100674901, ; jnienv_registerjninatives_method_token
...
@__DSOCacheEntry_name.1 = internal constant [22 x i8] c"libDXEditorsNative.so\00", align 16
@__DSOCacheEntry_name.2 = internal constant [18 x i8] c"libmono-native.so\00", align 16
@__DSOCacheEntry_name.3 = internal constant [16 x i8] c"libe_sqlite3.so\00", align 16
...
@dso_cache = local_unnamed_addr global [28 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; ignore
		i8* getelementptr inbounds ([22 x i8], [22 x i8]* @__DSOCacheEntry_name.1, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 1
	%struct.DSOCacheEntry {
...
@assembly_store_bundled_assemblies = local_unnamed_addr global [82 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 16
